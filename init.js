...
db.exec("create table if not exists `village` (`id` integer primary key autoincrement,`name` text,`jianjie` text,`banzi` text,`beizhu` text);");

db.exec("insert into `village` (`name`, `jianjie`, `banzi`, `beizhu`) values ('新立屯村', '', '', ''), ('双榆树村', '', '', ''), ('一间楼村', '', '', ''), ('贾家屯村', '', '', ''), ('腰营子村', '', '', ''), ('大石桥村', '', '', ''), ('莲花山村', '', '', ''), ('公立亨村', '', '', ''), ('东大门村', '', '', ''), ('冷家店村', '', '', '');");

db.exec("create table if not exists `person` (`id` integer primary key autoincrement,`touxiang` text,`xingming` text,`zhen` text,`cun` text,`huzhu` text, `minzu` text, `shengri` text,`yuhuzhuguanxi` text,`jiankangqingkuang` text,`wenhuachengdu` text,`lianxidianhua` text,`zhengzhimianmao` text,`pinkunhushuxing` text,`zhipinyuanyin` text,`beizhu` text,`yujituopinnianfen` text);");
...
db.exec("create table if not exists `article` (`id` integer primary key,`type` text,`title` text,`content` text);");
